  ...
  projects: [
    {
      id: 1,
      title: "Tierlyst",
      description: "Um editor visual de Tier List responsivo, desenvolvido em React com suporte a drag & drop, multi idiomas e animações suaves.",
      techStack: ["Next.js", "TypeScript", "Framer Motion", "Tailwind CSS", "Next Intl", "Radix UI"],
      githubUrl: "",
      ...
      id: 2,
      title: "Pomodoro Web",
      description: "Um dos primeiros projetos que fiz, usando somente HTML, CSS e Javascript. Um cronômetro Pomodoro simples e funcional.",
