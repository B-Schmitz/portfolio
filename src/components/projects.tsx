  ...
  return (
    <section id="projects" className="py-24 sm:py-32 bg-background/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-bold tracking-tight text-foreground font-headline sm:text-5xl">{strings.projects.title}</h2>
          <p className="mt-4 text-lg text-muted-foreground">{strings.projects.subtitle}</p>
        </motion.div>
